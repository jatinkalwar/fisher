...
##   Fisher  	: 	Automated Phishing Tool
##   Author 	: 	JATIN KALWAR
##   Version 	: 	7.6
##   Github 	: 	https://github.com/jatinkalwar

### Version 2.1 created by HTR-TECH



##      Copyright (C) 2021  JATIN KALWAR (https://github.com/jatinkalwar)
...
jatt() {
	...
	cat <<- EOF
		...
		${RED}[${WHITE}99${RED}]${ORANGE} Main Menu         ${RED}[${WHITE}00${RED}]${ORANGE} Exit
...
banner
echo -e " "
echo -e "\e[93mPLEASE WAIT WE ARE INSTALLING PAKAGES" | pv -qL 50
kill_pid
dependencies
install_ngrok
clear
